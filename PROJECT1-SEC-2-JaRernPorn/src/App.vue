...
<template>
  <section class="category" v-if="allPage.categoryPage">
    <div class="p-7 bg-main-bgColor h-screen overflow-y-hidden">
      ...
      <header>
        <img class="w-16 absolute hover:w-catePage-20 transition-all duration-300 ease-in-out"
          src="./assets/categories/icon/left-arrow-01.png" alt="left-arrow" />
      ...
      <div class="allbox flex content-center justify-center mt-14">
        <div class="boxes font-semibold text-black font-outfit flex flex-col flex-wrap">
          <div class="firstLine flex flex-col md:flex-row space-x-0 md:space-x-28 pb-10 md:flex-wrap">
